#!/usr/bin/perl -w
# Matthew Chang - fungal genus classifier
...
USAGE:
perl FungalGenusClassifier.pl -infile <fasta file> -outfile <output classification> -numthreads <number of concurrent processes>";
